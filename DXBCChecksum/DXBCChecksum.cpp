...
{
    array<System::Int32>^ DXBCChecksum::CalculateDXBCChecksum(array<System::Byte>^ data)
    {
        ...
        array<System::Int32>^ hash = gcnew array<System::Int32>(4);
        for (int i = 0; i < 4; i++) hash[i] = md5Ctx.buf[i];
